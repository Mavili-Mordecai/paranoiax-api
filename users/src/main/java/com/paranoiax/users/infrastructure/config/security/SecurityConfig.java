    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/v1/users/devices/*/recovery").permitAll()
                        ...
                        .requestMatchers("/v1/users/recovery-points/challenge").permitAll()
                        .requestMatchers("/v1/users/recovery-points/access").permitAll()
